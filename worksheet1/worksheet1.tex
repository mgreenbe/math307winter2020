...
1 - z^2 = 1-(x+iy)^2 = 1 - (x^2 - y^2 + 2ixy) = (1-x^2+y^2) - 2ixy
    ...
    \begin{solution}
        \begin{multline*}
            ...
            \frac{x^3 - 3xy^2}{(x^2+y^2)^3} + i\frac{-3x^2y  + y^3}{(x^2+y^2)^3}
            \end{multline*}
    \end{solution}
...
\end{parts}
    ...
    \begin{parts}
        ...
        \part $|z+3| - |z-3| = 4$
        \begin{solution}
            The set of points the difference of whose distances from $(-3,0)$ and $(3,0)$ is equal to $\pm4$ is a hyperbola with foci at $-3$ and $3$.
            By the symmetries of the equation $|z+3| - |z-3| = 4$, the hyperbola is in standard position and orientation. Thus, it has an equation of the form
    ...
    \]
    To determine $b$, first find another point on the hyperbola. Let's find the points $z=3\pm iy$ that lie on the hyperbola. By the defining equation,
    \[
        |3+iy + 3| - |3+iy - 3|=4.
    \]
    The solutions of this equation are $y=\pm \frac52$.
    Plugging $x=3$, $y=\frac52$ into \[\frac{x^2}{2^2} + \frac{y^2}{b^2}=1,\] and solving for $b$, we get $b=\sqrt5$.
    Thus, the hyperbola has cartesian equation
    \[
        ...
        \begin{solution}
            As $\Im z^2 = 2xy$,
            \[
                \Im z^2=4\Longleftrightarrow 2xy=4\Longleftrightarrow xy=2.
            \]
            The graph of $xy=2$ is a rectangular hyperbola.
        \end{solution}
    \end{parts}
